...
public class Player extends Character {
	...
	public Player(float x, float y) throws SlickException {
		...
		setSprite(new Image("data/images/characters/player/mainstill.png") /*
																			 * new
																			 * Image
																			 * (
																			 * "data/images/characters/player/homerstill.png"
																			 * )
																			 */);
		// setMovingAnimation(new Image[]{new
		// Image("data/img/characters/player/player_1.png"),new
		// Image("data/img/characters/player/player_2.png"),
		// new Image("data/img/characters/player/player_3.png"),new
		// Image("data/img/characters/player/player_4.png")}
		// ,125);

		// setAnimation("data/images/characters/player/homeranim.png");
		setAnimation(
				/* "data/images/characters/player/homeranimsmall.png" */"data/images/characters/player/mainanim.png",
				20, 43, 8);

		setJumpAnimation("data/images/characters/player/mainanimjump.png", 20,
				43, 250, 3);
